        ...
        <div class="card-body">
            <div>
               <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                ...
                <button type="button" class="btn btn-warning" onclick="verreporte();" data-toggle="modal" data-target="#exampleModal">
                    Ver reporte
                </button>
                </div><br>
            ...
            <div class="modal-body">
                <form action="" method="post" name="formulario" id="formulario">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                        <input type="hidden" name="idcliente" id="idcliente" class="form-control" value="" />
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="telefono" name="telefono" aria-hidden="true">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                                    ...
                                    <select class="form-control form-control-sm-3" name="lugar" id="lugar">
                                        
                                        <option value="Ciudad Dorada">Ciudad Dorada</option>
                                        <option value="Los Angeles">Los Angeles</option>
                                        <option value="Villa San Sebastian">Villa San Sebastian</option>                      
                                    </select>
                                </div>
                        <div>
...
<br><br>
    ...
    <script type="text/javascript" src="script/cita.js"></script>
